...
@Table(name = "user")
@Getter
@Setter // This will generate both getters and setters for all fields. Lombok's annotation creates all this for us
public class User {
    ...
    // Required by JPA, this constructor does not get automatically generated by Lombok, so you need to explicitly define it.
    public User(){
    }
